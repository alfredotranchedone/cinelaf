...
class FilmControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        factory(Film::class)->create(['titolo' => '## A Filter ##', 'user_id' => $user->id])
            ->each(function ($film) use ($user) {
                $film->regista()->save(factory(Regista::class)->make());
                $film->rating()->save(new Rating([
                    'user_id' => $user->id,
        ...
        factory(Film::class)->create(['titolo' => '## B Filter ##', 'user_id' => $user->id])
            ->each(function ($film) use ($user) {
                $film->regista()->save(factory(Regista::class)->make());
            });
    ...
    public function testGetAll()
    {
        ...
        $response = $this->getJson(route('api.film.all'));
    ...
    public function testGetDatatableFormattedMovie()
    {
        ...
        $response = $this->getJson(route('api.film.dt.all', [
            'search' => ['value' => null],
            'length' => 5,
            'start' => 0,
            'order' => [[
    ...
    public function testGetDatatableFormattedMovieRatedByCurrentUser()
    {
        ...
        $response = $this->getJson(route('api.film.dt.myratings', [
            'search' => ['value' => null],
            'length' => 5,
            'start' => 0,
            'order' => [[
    ...
    public function testGetDatatableFormattedMovieNotRatedByCurrentUser()
    {
        ...
        $response = $this->getJson(route('api.film.dt.mynotrated', [
            'search' => ['value' => null],
            'length' => 5,
            'start' => 0,
            'order' => [[
    ...
    public function testGetDatatableFormattedMovieNoQuorumByCurrentUser()
    {
        ...
        $response = $this->getJson(route('api.film.dt.noquorum', [
            'search' => ['value' => null],
            'length' => 5,
            'start' => 0,
            'order' => [[
